...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['edit_id'])) {
    ...
    $allowed_languages = [
        ...
        'Dart', 'Elixir', 'Lua', 'R', 'Perl', 'C#', 'Julia'
    ];
...
<head>
    ...
    <style>
        ...
        .edit-link { background: #2a4a8a; color: white; }
        ...
        .cancel-link a { color: #ffaa66; }
        .btn-save { background: #2a4a8a; }
    </style>
</head>
<body>
...
<div class="container">
    <div class="site-header">
        <div class="header-left">
            <img src="image.jpg" alt="Profile" class="profile-photo" onerror="this.src='https://randomuser.me/api/portraits/women/1.jpg'">
            <h1>🔧 Админ-панель</h1>
        </div>
        <div class="nav-links">
            <a href="index.php">Главная</a>
            <a href="v.php">Анкеты</a>
            <a href="admin.php" style="color:#ffaa66;">Админ</a>
        </div>
    </div>
        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <?php if (empty($applications)): ?>
                    <td><td colspan="8" style="text-align:center;">Пока нет ни одной анкеты</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
